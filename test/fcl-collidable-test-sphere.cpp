/*
 * fcl-collidable-test-sphere.cpp
...
#define SMURF_COLLIDABLE_SPHERE_FRAME_NAME std::string("sphere")
...
int main(int argc, char **argv) {
    ...
    const std::string path="./smurf/just_a_sphere/smurf/just_a_sphere.smurf";
    ...
    viz.write(*(graphLoader.getGraph()), "fcl-collidable-test-sphere.dot");
